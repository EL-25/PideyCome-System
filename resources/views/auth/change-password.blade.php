...
<body class="bg-[#F2E7DC] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-md rounded-[3rem] shadow-2xl border-t-[12px] border-[#F28705] overflow-hidden p-10" x-data="{ show1: false, show2: false }">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input :type="show1 ? 'text' : 'password'" name="password" required 
                        class="w-full pl-12 pr-12 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-[#F28705] outline-none font-bold transition">
                    <button type="button" @click="show1 = !show1" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#F28705]">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input :type="show2 ? 'text' : 'password'" name="password_confirmation" required 
                        class="w-full pl-12 pr-12 py-4 bg-gray-50 border-2 border-transparent rounded-2xl focus:border-[#F28705] outline-none font-bold transition">
                    <button type="button" @click="show2 = !show2" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#F28705]">
